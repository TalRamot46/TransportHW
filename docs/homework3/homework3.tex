...
$\mathbf{M}_{\text{e}},\mathbf{M}_{\text{o}}$ and evaluating at $x=a/2$ gives $M$ homogeneous
equations $\mathbf{H}(a/2)\mathbf{C}=\mathbf{0}$ with
\begin{equation}
    \mathbf{H}_{\cdot1}=\mathbf{M}_{\text{e}}\mathbf{v}_1\cos\!\left(\tfrac{B_0a}{2}\right)
        +\mathbf{M}_{\text{o}}(\mathbf{B}\mathbf{v}_1)B_0\sin\!\left(\tfrac{B_0a}{2}\right),
    \quad
    \mathbf{H}_{\cdot j}=\mathbf{M}_{\text{e}}\mathbf{v}_j\cosh\!\left(\tfrac{\kappa_ja}{2}\right)
        -\mathbf{M}_{\text{o}}(\mathbf{B}\mathbf{v}_j)\kappa_j\sinh\!\left(\tfrac{\kappa_ja}{2}\right)
\end{equation}
